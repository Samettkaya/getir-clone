...
export const Footer = () => {
    return( 
        <div className='bg-white  md:mt-16'>
            <div className='md:container  mx-auto lg:pb-5  md:pt-[40px]'>
                <div className='md:flex flex-row md:px-[24px] lg:px-[24px] pt-4 px-4 md:pt-0 '>
                    ...
                    <div className='basis-[276.5px] mt-6 md:mt-0 flex  flex-col' >
                        <div>
                    ...
                    <div className='hidden  lg:flex justify-end basis-[104px] '>
                ...
                <div className=' h-[165px] md:h-20 text-[13px] lg:p-6 p-4 md:py-6 md:flex justify-between items-center md:bg-white bg-[#F5F5F5] border-t border-solid border-[#f3f0fe]'>
